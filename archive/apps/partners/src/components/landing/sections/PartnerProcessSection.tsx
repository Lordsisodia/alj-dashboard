...
const steps = [
  {
    day: 'Day 1',
    title: 'Kickoff & Goals',
    description: 'Align on offer, ICP, must-have features, and success metric.',
    duration: '30–45 min',
  ...
  },
  {
    ...
    description: 'AI + design pod drafts flows, copy, and screens you can click.',
    duration: '2–4 hrs',
  ...
  },
  {
    day: 'Day 2',
    title: 'Build & Polish',
    description: 'Ship the working MVP, wire data hooks, and tune for demo.',
    duration: '1 day',
  ...
  },
  {
    ...
    description: 'Review, iterate, then push live with support and playbooks.',
    duration: '1–2 hrs',
  ...
  <section className="py-12 md:py-16 relative overflow-hidden">
    <div className="container mx-auto px-4">
      ...
      >
        ...
        >
          From hello to live in 48 hours
        </GradientHeading>
        <p className="text-sm sm:text-base text-siso-text-muted max-w-2xl mx-auto">
          Clear checkpoints, daily deliverables, and a partner squad that ships fast.
        </p>
      </motion.div>
