...
const PartnerProcessSection = lazy(() => import('./sections/PartnerProcessSection').then(m => ({
...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-b from-black via-siso-bg to-black">
