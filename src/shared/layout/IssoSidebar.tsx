...
import {
  LayoutDashboard, Calendar, Lightbulb, Upload, Users, BarChart2,
  CheckSquare, Rss, Search, Radar, Bot, UserPlus, Settings,
...
export function IssoSidebar({ showCollapseToggle = true }: IssoSidebarProps) {
  ...
  return (
    ...
    >
      ...
      {/* Account selector (models switcher) */}
      <AnimatePresence>
        {!collapsed && (
          <motion.div
            key="account-section"
