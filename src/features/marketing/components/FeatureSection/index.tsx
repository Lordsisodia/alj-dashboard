        ...
        <div style={{
          ...
          <div style={{ textWrap: 'pretty', maxWidth: '512px' }}>
            <p style={{
              ...
              Say goodbye to juggling half-baked tools. ISSO offers enterprise grade functionality with beginner friendly ease of use.
            </p>
          </div>
        </div>
