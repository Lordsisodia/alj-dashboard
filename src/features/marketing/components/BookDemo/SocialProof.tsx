...
function ReviewBadge({
  ...
  return (
    <a href="#" className="demo-socialproof-item w-inline-block">
      <div className="demo-socialproof-content">
        <div className="demo-socialproof-icon-2">{icon}</div>
      ...
      <div className="demo-socialproof-item-name">
        <div className="text-overline">{name}</div>
      </div>
    </a>
  );
}
        ...
        <div className="section-white-block">
          <div className="container section-container">
            <div className="div-block-340">
              <div className="demo-socialproof">
                <div className="demo-socailproof-head-copy">
              ...
              <div className="code-iframe">
                <div
                  ...
                  data-id="26b5df20-f5c6-41fa-a198-c3bcb97d0f42"
                  data-mode="shadow"
                  data-lazyload="false"
