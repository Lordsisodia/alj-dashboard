...
export default function ReadyToShipCTA() {
  return (
    <section style={{ background: '#000', overflow: 'hidden' }}>
      <div className="home-cta" style={{ maxWidth: '1216px', margin: '0 auto', padding: '108px 24px 0', display: 'flex', flexDirection: 'column', gap: '36px' }}>
        <div className="section-head is-large" style={{ zIndex: 2, maxWidth: '960px', position: 'relative' }}>
          <h2 className="home-cta-headline" style={HEADLINE_STYLE}>
        ...
        <div className="main-cta-buttons" style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap', justifyContent: 'flex-start', position: 'relative', zIndex: 2 }}>
          ...
          >
            <span style={BUTTON_BASE}>Start</span>
          ...
          >
            <span style={BUTTON_BASE}>View Pricing</span>
          </a>
        </div>
