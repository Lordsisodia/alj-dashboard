...
export const SignInPage: React.FC<SignInPageProps> = ({
  ...
  return (
    <div className="h-[100dvh] flex flex-col md:flex-row w-[100dvw]" style={{ background: '#020308', fontFamily: 'Inter, sans-serif' }}>
          ...
          <div className="flex flex-col gap-6">
            ...
            <form className="space-y-5" onSubmit={onSignIn}>
              ...
              <div className="animate-element animate-delay-300">
                <label className="text-sm font-medium text-white/45 mb-1.5 block">Email Address</label>
                <GlassInputWrapper>
                  <input name="email" type="email" placeholder="Enter your email address"
                    className="w-full bg-transparent text-sm p-4 rounded-2xl focus:outline-none text-white placeholder-white/25" />
                </GlassInputWrapper>
              </div>

              <div className="animate-element animate-delay-400">
                <label className="text-sm font-medium text-white/45 mb-1.5 block">Password</label>
                <GlassInputWrapper>
                  <div className="relative">
                    <input name="password" type={showPassword ? 'text' : 'password'} placeholder="Enter your password"
                      className="w-full bg-transparent text-sm p-4 pr-12 rounded-2xl focus:outline-none text-white placeholder-white/25" />
              ...
              <div className="animate-element animate-delay-500 flex items-center justify-between text-sm">
                ...
                <button type="button" onClick={onResetPassword} className="text-violet-400 hover:underline transition-colors">
                  Reset password
                </button>
              </div>
            ...
            <div className="animate-element animate-delay-700 relative flex items-center justify-center">
              ...
              <span className="px-4 text-sm text-white/40 absolute" style={{ background: '#020308' }}>Or continue with</span>
            </div>

            <button onClick={onGoogleSignIn}
              className="animate-element animate-delay-800 w-full flex items-center justify-center gap-3 border border-white/10 rounded-2xl py-4 text-white/70 hover:bg-white/5 transition-colors">
              <GoogleIcon />
            ...
            <p className="animate-element animate-delay-900 text-center text-sm text-white/40">
              No account?{' '}
              <button type="button" onClick={onCreateAccount} className="text-violet-400 hover:underline transition-colors">
                Start free trial
              </button>
            </p>
          </div>
