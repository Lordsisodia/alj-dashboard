  ...
  return (
    <>
      ...
      >
            ...
            <div className="relative flex-shrink-0">
              {c.favorited && (
                <div
                  ...
                  style={{ background: 'linear-gradient(135deg, #ff0069, #833ab4)', padding: '2.5px', borderRadius: '50%', margin: '-2.5px' }}
                />
              )}
              <div
                className="w-14 h-14 rounded-full flex items-center justify-center text-base font-bold text-white relative z-10"
        ...
        {/* Reels feed — full width, no sidebar */}
