...
export const optimal: PortfolioClient = {
  ...
  metadata: { featured: false, showInPortfolio: false, seoTitle: 'Optimal Building Maintenance | SISO Portfolio', seoDescription: 'Construction management system', tags: ['construction', 'management'] }
};
