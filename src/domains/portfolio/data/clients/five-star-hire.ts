...
export const fiveStarHire: PortfolioClient = {
  ...
  pricing: { marketValue: 7000, sisoPrice: 997, currency: 'GBP', savings: 86 },
  features: { key: ['Vehicle catalog', 'Booking system', 'Client management'], technical: [], integrations: ['Payments'], tokens: { estimate: '120m' } },
  techStack: { frontend: ['React', 'TypeScript'], backend: ['Node.js'], database: ['PostgreSQL'], hosting: ['Vercel'], tools: ['Vite'] },
  media: {
    logo: '/portfolio/five-star-hire/logo.png',
    hero: '/portfolio/five-star-hire/desktop/hero-top.webp',
    screenshots: {
      desktop: [
        '/portfolio/five-star-hire/desktop/hero-top.webp',
        '/portfolio/five-star-hire/desktop/hero-1.png',
        '/portfolio/five-star-hire/desktop/hero-2.png',
        '/portfolio/five-star-hire/desktop/cars.png',
      ],
      mobile: ['/portfolio/five-star-hire/mobile/home.png'],
      features: [],
    },
  },
