...
export const industries: Industry[] = [
  {
    ...
    templateShowcase: {
      description: 'Online reservations, menu showcase, table management, and Stripe payments.',
      reusableComponents: [
        'Table Reservations',
        'Menu Gallery',
        'Ordering & Payments',
        'Shift & Table Management',
      ],
    },
    seoMetadata: {
  ...
  {
    id: 'food-beverage',
    name: 'Elementary Restaurant',
    slug: 'elementary-restaurant',
    description: 'A full-stack restaurant site with reservations, menu gallery, and Stripe payments built for Elementary.',
    icon: UtensilsCrossed,
    color: 'bg-amber-500',
    headerImage: 'https://images.unsplash.com/photo-1521017432531-fbd92d768814?w=1200&h=400&fit=crop',
    templateShowcase: {
      description: 'Online reservations, live table status, menu cards, and checkout with Stripe.',
      reusableComponents: [
        'Table Reservations',
        'Menu Gallery',
        'Ordering & Payments',
