...
function AvatarCircle() {
  return (
    <div className="relative rounded-full shrink-0 size-8 bg-siso-bg-secondary">
...
export function IconNavigation({
  ...
  return (
    <aside
      ...
      className={`bg-siso-bg-secondary flex flex-col items-center overflow-hidden px-2 py-3 w-16 flex-shrink-0 ${heightClass} h-screen sticky top-0 border-r border-neutral-800 rounded-l-2xl`}
    >
