...
const PARTICLE_PRESETS = [
  { top: 12, left: 8, delay: 0.2 },
  { top: 22, left: 68, delay: 1.1 },
  { top: 34, left: 42, delay: 2.4 },
  { top: 46, left: 78, delay: 0.7 },
  { top: 52, left: 16, delay: 1.9 },
  { top: 61, left: 33, delay: 3.2 },
  { top: 68, left: 84, delay: 4.0 },
  { top: 75, left: 58, delay: 0.4 },
  { top: 82, left: 24, delay: 2.8 },
  { top: 88, left: 71, delay: 1.5 },
  { top: 14, left: 90, delay: 3.8 },
  { top: 28, left: 55, delay: 4.6 },
  { top: 39, left: 12, delay: 1.3 },
  { top: 57, left: 92, delay: 2.1 },
  { top: 64, left: 47, delay: 3.4 },
];
    ...
    <section className="py-12 md:py-16 relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute inset-0 overflow-hidden">
          {useMemo(
            () => PARTICLE_PRESETS.slice(0, isMobile ? 8 : 15),
            [isMobile]
          ).map((particle, i) => (
            <div
              key={i}
