            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  >
                    <button
                      className="text-lg px-8 py-4 font-semibold shadow-2xl w-full sm:w-auto rounded-lg bg-gradient-to-r from-siso-red to-siso-orange text-white hover:opacity-90 transition-opacity flex items-center justify-center"
