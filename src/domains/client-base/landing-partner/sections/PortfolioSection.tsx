...
const categoryHeaders: Record<PortfolioCategory | 'all', { image: string; title: string; description: string }> = {
  'all': {
    image: 'https://images.unsplash.com/photo-1497366216548-37526070297c?w=1200&h=400&fit=crop',
    title: 'All Projects',
    description: 'Explore our complete portfolio of innovative solutions across all industries'
  },
  'events': {
    image: 'https://images.unsplash.com/photo-1511578314322-379afb476865?w=1200&h=400&fit=crop',
    title: 'Events',
    description: 'Event management platforms that bring people together and create unforgettable experiences'
  },
  'restaurant': {
    image: 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=1200&h=400&fit=crop',
    title: 'Restaurant',
    description: 'Digital solutions that transform dining experiences and streamline restaurant operations'
  },
  'beauty': {
    image: 'https://images.unsplash.com/photo-1560066984-138dadb4c035?w=1200&h=400&fit=crop',
    title: 'Beauty & Wellness',
    description: 'Elegant platforms for beauty salons, spas, and wellness businesses'
  },
  'fintech': {
  ...
  'real-estate': {
    ...
    title: 'Real Estate',
    description: 'Property management and real estate platforms that simplify the buying and selling process'
  }
};
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          <div className="relative overflow-hidden rounded-2xl h-[300px] md:h-[400px] group">
            {/* Image */}
            <img
              src={categoryHeaders[activeFilter].image}
              alt={categoryHeaders[activeFilter].title}
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 md:p-10">
              ...
              >
                {categoryHeaders[activeFilter].title}
              </motion.h3>
              <motion.p
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
              ...
              >
                {categoryHeaders[activeFilter].description}
              </motion.p>
            </div>

            {/* Decorative Elements */}
            <div className="absolute top-4 right-4 px-3 py-1 bg-siso-orange/90 rounded-full text-white text-sm font-medium">
        ...
        {/* Portfolio Grid */}
        <motion.div
          key={`${activeFilter}-grid`} // Re-animate when filter changes with a unique key
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.div
          ...
          className="text-left"
        >
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 sm:gap-6 p-6 sm:p-7 rounded-2xl bg-gradient-to-br from-gray-900 via-gray-900/85 to-black border border-white/10 shadow-xl shadow-black/30">
            <div className="space-y-2">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 text-xs uppercase tracking-wide text-gray-200">
                Partners
              </div>
              <h3 className="text-2xl sm:text-3xl font-semibold text-white leading-snug">
                Ready to work with SISO and earn income on the side?
              </h3>
              <p className="text-gray-300 text-sm sm:text-base max-w-xl">
                Plug into our build team, share deals, and collect recurring partner earnings.
              </p>
            </div>
            <a
              href="/onboarding-chat"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-gradient-to-r from-siso-red to-siso-orange text-white font-semibold shadow-lg shadow-siso-orange/25 hover:opacity-90 transition-all duration-200 min-w-[150px]"
            >
              Get started
